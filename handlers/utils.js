...
module.exports = async (client) => {
  ...
  client.buttons = (enable) => {
    let raw = new MessageActionRow().addComponents([
      ...
      new MessageButton()
        .setStyle("SECONDARY")
        .setCustomId("pre")
      .setEmoji("<:9710156757567:1049980375386042400>")
        .setDisabled(enable),
      new MessageButton()
      .setStyle("SECONDARY")
        .setCustomId("skip")
  ...
  client.queueembed = (guild) => {
    let embed = new MessageEmbed()
      .setColor(client.config.embed.color)
      .setTitle(`${guild.name} Queue List`)
  ...
  client.playembed = (guild) => {
    let embed = new MessageEmbed()
      ...
      .setDescription(
        ` [Invite](${client.config.links.inviteURL}) | [Support](${client.config.links.DiscordServer}) `
      )
      .setImage(
        guild.banner
          ? guild.bannerURL({ size: 4096 })
          : `https://media.discordapp.net/attachments/1017008782527692800/1017139232155897876/matte_painting.jpg?width=1193&height=671`
      )
